# Database models for Movie Ticket System
# Created by Wimalsha - Database Administrator
...
class Movie(models.Model):
    ...
    poster_url = models.URLField(blank=True, null=True)  # ✅ URL only, no file upload
